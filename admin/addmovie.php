            ...
            <div class="admin-section-column">
                ...
                <div class="admin-section-panel admin-section-panel2">
                    ...
                    <form action="" method="POST">
                        ...
                        <label>Price</label>
                        <input placeholder="Main Hall" type="number" name="mainhall" required><br />
                        <input placeholder="Vip-Hall" type="number" name="viphall" required><br />
                        <input placeholder="Private Hall" type="number" name="privatehall" required><br />
                        <br>
