...
<body>
	...
	<div>
		...
		$db = mysqli_select_db($con, "kismet_db_final");
						...
						<tr>
							<td class="title">
								<div class="footer-brand">
									<h1 class="footer-heading">Kismet Cinema</h1>
								</div>
							</td>
							<td>
								Invoice #: <?php echo $ORDERID; ?><br>
								Created: <?php date_default_timezone_set('Asia/Manila');
	...
	<div style="max-width: 300px; margin:auto; padding: 30px;">
		...
		<a type="button" class="btn btn-success" href='http://localhost/kismet_cinema_php/index.php'>Home-Page</a>
	</div>
